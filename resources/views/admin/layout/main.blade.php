...
<body class="">
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                  <a class="dropdown-item" href="{{url('/admin/usuario')}}">Perfil</a>
                  <div class="dropdown-divider"></div>
                  <ul class="navbar-nav ml-auto">
                    <a class="nav-link dropdown-item" href="{{ url('/admin/logout') }}"
  ...
  <script src="{{ asset('js/dashboard/material-dashboard.js?v=2.1.1') }}" type="text/javascript"></script>
